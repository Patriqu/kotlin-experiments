package com.siriusbase.plugins
...
class CityService(private val connection: Connection, private val ioDispatcher: CoroutineDispatcher = Dispatchers.IO) {
    companion object {
    ...
    // Create new city
    suspend fun create(city: City): Int = withContext(ioDispatcher) {
    ...
    // Read a city
    suspend fun read(id: Int): City = withContext(ioDispatcher) {
    ...
    // Update a city
    suspend fun update(id: Int, city: City) = withContext(ioDispatcher) {
